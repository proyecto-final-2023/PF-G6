...
export default function CardTraineePlans({ first_name, last_name, imgURL, trainee }: Props): JSX.Element {
  ...
  return (
    <div>
      <ul className="max-w-md rounded-md divide-y bg-[url('/tail-imgs/1zLe.gif')] bg-no-repeat bg-cover bg-bottom divide-gray-200 bg-gray-800 m-2 " onClick={handleClick}>
