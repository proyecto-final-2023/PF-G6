...
function GraphContainer() {
  ...
  const label1 = "User";
  //---------------------------------------------------------------------------------------------
  let scores1 = [dataset?.user.countUser, dataset?.user.countTrainer, dataset?.user.countTrainee]
  if(!scores1.every(Boolean)) scores1=[1]; 
...
//-----------------------------------------------------------------------------------------------
  ...
  return (
    <div className="flex justify-around flex-wrap pt-20 gap-8">
      <GraficBar scores={scores1} labels={labels1} label={label1} title={title1} />
