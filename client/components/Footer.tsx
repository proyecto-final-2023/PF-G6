...
export default function Footer() {
  return (
    <div className="w-full text-amber-800 rounded-lg shadow flex items-center justify-between p-8 bg-gray-800 position relative bottom-0 min-h-max border-4 border-gray-800 border-t-yellow-900 sm:flex-col">
