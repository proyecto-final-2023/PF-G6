...
export default function Footer() {
  return (
    <div className=" w-full p-2 text-amber-800 rounded-lg shadow md:flex md:items-center md:justify-between md:p-8 dark:bg-gray-800 border-4 border-gray-800  border-t-yellow-900 min-h-30 relative bottom-0">
