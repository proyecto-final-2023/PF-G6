      ...
      <div className="mx-auto grid max-w-7xl gap-y-20 gap-x-8 px-6 lg:px-8 xl:grid-cols-3">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-justify leading-8 text-white ">
            ...
            miembros con experiencia en desarrollo de software, hemos diseñado
            una interfaz de usuario. Ésta aplicación proporciona ejercicios
            físicos, entrenamientos personalizados, seguimientos de progresos y
            planificación de comidas saludables. Con una plataforma intuitiva
            para cada usuario y características avanzadas. Fit-U es una solución
