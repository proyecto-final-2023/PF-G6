      ...
      <div className="h-auto pt-[82px]">
          ...
          <ul className="backdrop-blur-md  bg-black bg-opacity-50 border border-white h-auto w-[350px] overflow-hidden flex flex-wrap">
            ...
            {selectedExercises
              ? selectedExercises.map((ex) => (
                  <li className="block w-[350px] px-5 py-1" key={ex.id}>
                    '{ex.name}'{" "}
                    <div>
                      <label htmlFor={`repeticiones-${ex.id}`}>
                        Repeticiones:
                      </label>
                      <select
        ...
        <div className="flex justify-evenly">
          <button
            ...
            onClick={() => setIsAlimentEndpoint(!isAlimentEndpoint)}
          >
        ...
        <div className="flex justify-between items-center w-full py-10 px-96">
          ...
          <div className="font-bold w-[35px] border border-white rounded-full py-2 backdrop-blur-lg bg-black bg-opacity-50 text-center">
            {currentPage}
          </div>
          <button
            onClick={nextPage}
