...
export default function politicas() {
  return (
    ...
    <p>El contenido de Fit-U, incluyendo texto, gráficos, imágenes, logos y cualquier otro material, es propiedad exclusiva de Fit-U o de sus licenciantes. No se permite la reproducción, modificación, distribución o uso no autorizado de estos materiales sin la previa autorización escrita de Fit-U.</p>
    <h5>3. Cambios en los Términos y Condiciones</h5>
    <p>Fit-U se reserva el derecho de cambiar estos Términos y Condiciones en cualquier momento sin previo aviso. Es responsabilidad del usuario revisar periódicamente estos Términos y Condiciones para estar al tanto de cualquier cambio. El uso continuado de la aplicación después de cualquier cambio en estos Términos y Condiciones se considerará como aceptación de dichos cambios.</p>
    <h5>4. Limitación de responsabilidad</h5>
    <p>Fit-U no será responsable de ningún daño indirecto, incidental, consecuente, especial o punitivo o de cualquier otro tipo resultante del uso de la aplicación, incluyendo, pero no limitado a, la pérdida de ingresos, la pérdida de datos o la interrupción del negocio.</p>
    <h5>5. Indemnización</h5>
    <p>El usuario acepta indemnizar y mantener a Fit-U, sus directores, empleados y licenciantes libres de cualquier reclamo, demanda, daño, costo o gasto, incluyendo honorarios de abogados, resultante del uso de la App </p> 
    </div>
  )
}
